    ...
    <div className="min-h-screen flex flex-col">
      ...
      <div className="bg-cdi-purple text-white px-6 py-12 sm:py-16 text-center">
        ...
        <div className="flex items-center justify-center gap-3 mt-6">
          <Link
            to="/about"
            className="inline-flex items-center px-4 py-1.5 rounded-full border border-white/30 bg-white/10 text-white text-xs font-medium hover:bg-white/20 hover:border-white/50 transition-all"
          >
            About this project
          </Link>
          <a
            ...
            className="inline-flex items-center gap-1.5 px-4 py-1.5 rounded-full border border-white/30 bg-white/10 text-white text-xs font-medium hover:bg-white/20 hover:border-white/50 transition-all"
          >
